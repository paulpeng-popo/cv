...
\usepackage[
    ...
    top=1.6 cm, % seperaation between body and page edge from the top
...
\begin{twocolentry}{
    ...
    \begin{highlights}
        ...
        \item Ollama, Streamlit, LangChain, Chroma
    \end{highlights}
\end{twocolentry}
...
\begin{twocolentry}{
    ...
    \begin{highlights}
        \item Repaired and integrated six subsystems using Django.
        \item Streamlined deployment with shell scripts and Docker Compose
        \item \textbf{Accumulating 70,000+ visits since its launch in September 2023}
        \item Django, SQL, Nginx, Docker
    \end{highlights}
\end{twocolentry}
...
\begin{twocolentry}{
    ...
    \begin{highlights}
        \item Developed a Linux kernel module for Fibonacci sequence calculation, optimizing performance through API analysis.
        \item C/C++, Linux Kernel
    \end{highlights}
\end{twocolentry}
...
\begin{twocolentry}{
    ...
    \begin{highlights}
        \item Built a simple chatroom supporting multiple users simultaneously using Sockets and Multi-process programming.
        \item C/C++, Socket Programming
    \end{highlights}
\end{twocolentry}
